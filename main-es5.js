...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addEntry = function (entry) {
...
var ChatEntryComponent = /** @class */ (function () {
    function ChatEntryComponent() {
        this.addEntry = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ChatEntryComponent.prototype.ngOnInit = function () {
        // setInterval(() => {
        //   this.addEntry.next(new Date().toISOString());
        // }, 4000);
    };
    ChatEntryComponent.prototype.onAddEntry = function (entryText) {
...
var ChatMessageProgressComponent = /** @class */ (function () {
    function ChatMessageProgressComponent() {
    }
    ChatMessageProgressComponent.prototype.ngOnInit = function () {
    };
    ...
    return ChatMessageProgressComponent;
}());
